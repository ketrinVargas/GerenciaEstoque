...
public interface INotasFiscais {
     ...
     * @return A nota fiscal com o código informado ou NULL caso a nota fiscal não
     *         seja encontrada.
     */
     ...
     * @return O total (soma do valor de todos os items) da nota fiscal com o código
     *         informado ou NULL caso a nota fiscal não seja encontrada.
     */
     ...
     * @return True caso o item foi adicionado com sucesso e False caso a nota
     *         fiscal não exista ou a quantidade do produto em estoque seja menos do
     *         que a solicitada.
     */
